  ...
  especiales: [
    {
      ...
      price: "$26",
      isSpecial: true,
      description: "Carne premium, doble panceta crujiente, doble cheddar, cebolla caramelizada lenta y salsa barbacoa casera. Todo en pan brioche tostado.",
    },
    {
      name: "Blue Cheese",
      sub: "Hamburguesa",
      price: "$24",
      description: "Medallón de carne premium, queso azul desmenuzado, cebolla caramelizada y cheddar en pan brioche. Intensa y elegante.",
    },
    {
      name: "Fugazzeta Rellena",
      sub: "Pizza",
      price: "$22",
      description: "Doble masa casera rellena de abundante muzzarella y cubierta de cebolla morada en aros con orégano y aceite de oliva extra virgen.",
    },
    {
      name: "Rúcula y Jamón Crudo",
      sub: "Pizza",
      price: "$24",
      description: "Muzzarella, rúcula fresca, finas fetas de jamón crudo serrano y hebras de parmesano reggiano rallado. Aceite de oliva al terminar.",
    },
  ],
  bebidas: [
    {
      name: "IPA Patagonia",
      sub: "Cerveza artesanal · 473ml",
      price: "$10",
      isSpecial: true,
      description: "Cerveza artesanal rubia Patagonia 24.7 IPA. Lúpulo intenso, refrescante y con carácter. Lata 473ml bien fría.",
    },
    {
      name: "Stella Artois",
      sub: "Cerveza premium · 473ml",
      price: "$9",
      description: "Cerveza premium Stella Artois rubia. Equilibrada, suave y refrescante. Lata 473ml.",
    },
    {
      name: "Coca-Cola",
      sub: "Gaseosa · 354ml",
      price: "$5",
      description: "Gaseosa refrescante sabor original en lata 354ml. También disponible en versión Zero.",
    },
    {
      name: "Agua Mineral",
      sub: "Sin gas · 500ml",
      price: "$4",
      description: "Agua mineral Nestlé pura de manantial 500ml. Fría y lista para acompañar tu pedido.",
    },
  ],
  postres: [
    {
      ...
      price: "$16",
      isSpecial: true,
      description: "Postre tibio con centro de chocolate líquido y crocante exterior de chocolate belga semi-amargo. Preparado al momento.",
    },
    {
      name: "Mousse de Chocolate Belga",
      sub: "Postre frío",
      price: "$14",
      description: "Exquisito mousse artesanal de chocolate belga semi-amargo con crema doble. Suave, aireado y profundo.",
    },
    {
      name: "Dulce de Leche y Nueces",
      sub: "Torta",
      price: "$15",
      description: "Capas alternadas de dulce de leche repostero premium y nueces crocantes trituradas. Un clásico nuestro.",
    },
  ],
};
