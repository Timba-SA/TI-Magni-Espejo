...
const products = [
  {
    ...
    name: "BBQ Smokehouse",
    type: "Hamburguesa",
    description: "Carne premium, doble panceta crujiente, doble cheddar, cebolla caramelizada lenta y salsa barbacoa casera en pan brioche tostado.",
    price: "$26",
    accent: "#FF5A00",
    letter: "B",
    processDetail: "— Salsa barbacoa casera",
  },
  {
    id: "fugazzeta",
    ...
    accent: "#C1121F",
    letter: "F",
    processDetail: "— Doble masa rellena",
  },
  {
    id: "volcan",
    name: "Volcán de Chocolate",
    type: "Postre",
    description: "Postre tibio con centro de chocolate líquido y crocante exterior de chocolate belga semi-amargo. Hecho al momento.",
    price: "$16",
    accent: "#D4A574",
    letter: "V",
    processDetail: "— Centro líquido al momento",
  },
];
